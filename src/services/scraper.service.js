...
class ValorantScraper {
  ...
  determinePlayerDivision(tournamentHistory) {
    ...
    const t1Tournaments = ['VCT', 'Masters', 'Champions', 'LOCK//IN', 'Challengers', 'VALORANT Champions'];

    const t2Tournaments = ['Challengers Ascension', 'Ascension', 'Challengers League', 'Contenders'];

    const t3Tournaments = ['Game Changers', 'GC', 'Rising', 'Valorant Regional League'];

    const t4Tournaments = ['Collegiate', 'University', 'College', 'Campus'];
...
export default new ValorantScraper();